...
===========+=========================+============================
 ...
 firmware header (stored at 0x08010000):
...
#define FLASH_FWHEADER_LEN	(0x100)
...
#define FLASH_FWHEADER_MAGIC	(FLASH_FWHEADER_START)
#define FLASH_FWHEADER_CODELEN	(FLASH_FWHEADER_START + 0x0004)
#define FLASH_FWHEADER_SIGINDEX1	(FLASH_FWHEADER_START + 0x0008)
#define FLASH_FWHEADER_SIGINDEX2	(FLASH_FWHEADER_START + 0x0009)
#define FLASH_FWHEADER_SIGINDEX3	(FLASH_FWHEADER_START + 0x000A)
#define FLASH_FWHEADER_FLAGS	(FLASH_FWHEADER_START + 0x000B)
#define FLASH_FWHEADER_SIG1		(FLASH_FWHEADER_START + 0x0040)
#define FLASH_FWHEADER_SIG2		(FLASH_FWHEADER_START + 0x0080)
#define FLASH_FWHEADER_SIG3		(FLASH_FWHEADER_START + 0x00C0)
